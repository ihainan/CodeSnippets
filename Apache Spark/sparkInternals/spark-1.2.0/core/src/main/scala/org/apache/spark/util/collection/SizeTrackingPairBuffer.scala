  ...
  extends SizeTracker with SizeTrackingPairCollection[K, V]
{
  ...
  private var capacity = initialCapacity  /* I: 缓冲区容量，默认为 64 个记录 */
  private var curSize = 0
  private var data = new Array[AnyRef](2 * initialCapacity) /* I: 两倍，存 Key 和存 Value */
  ...
  private def growArray(): Unit = {
    ...
    val newCapacity = capacity * 2  /* I: 两倍扩容 */
